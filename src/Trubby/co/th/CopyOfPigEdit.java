...
public class CopyOfPigEdit extends EntityArmorStand {
	public CopyOfPigEdit(World world) {
		super(world);
	}
	...
	public void normalize() {
		...
		if (headZ < 0.0F) {
			...
			setHeadPose(new Vector3f(0.0F, 0.0F, headZ - 5.0F));
		} else if (this.yaw % 4.0F != 0.0F) {
			setYawPitch(this.yaw + this.yaw % 4.0F, this.pitch);
		}
	}
